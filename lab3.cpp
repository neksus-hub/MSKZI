...
int main()
{
    ...
    vector<uint8_t> S = { 0x5, 0xD, 0xF, 0x6, 0x9, 0x2, 0xC, 0xA, 0xB, 0x7, 0x8, 0x1, 0x4, 0x3, 0xE, 0x0 };
    ...
    cout << "1)Операция замены 4-битного вектора:" << endl;
    cout << "   Input vector:  ";
    ...
    cout << "3) Операция перестановки 8-битного вектора с использованием кругового сдвига:" << endl;
    cout << "   Input vector:  ";
    print_vector(input_16);
    for (long unsigned int i = 0; i < input_8.size(); i++) {
